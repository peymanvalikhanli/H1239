...
export default class personal_document extends PureComponent {
    ...
    handleBackPress = () => {
        ...
        this.props.navigation.replace(this.state.parent, { data: this.state.data, parent: this.state.main_parent , userProfile: this.state.userProfile , userid: this.state.userid, doc_icon: this.state.doc_icon, doc_color: this.state.doc_color , doc_data: this.state.doc_data });
        return true;
    }
    ...
    render() {
        ...
        this.setState({ transId: data.transId == null ? data.TransId : data.transId, data: data, parent: parent, main_parent: main_parent, userid: userid, userProfile: userProfile, doc_data:doc_data, doc_icon:doc_icon, doc_color:doc_color, Type:Type });
        ...
        return (
            <Container style={{ flex: 1 }}>
                <Header>
                    <Left>
                        <Button
                            onPress={() => { this.props.navigation.replace(this.state.parent, { data: data, parent: main_parent, userid: userid, userProfile: userProfile,doc_icon: doc_icon, doc_color: doc_color , doc_data: doc_data }); }}
                        >
